 ...
 * Original file: /home/robi/projects/android/beam/beam/src/com/rei/lolchat/service/aidl/IRoster.aidl
 */
package com.rei.lolchat.service.aidl;
public interface IRoster extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.rei.lolchat.service.aidl.IRoster
{
private static final java.lang.String DESCRIPTOR = "com.rei.lolchat.service.aidl.IRoster";
...
/**
 * Cast an IBinder object into an com.rei.lolchat.service.aidl.IRoster interface,
 * generating a proxy if needed.
 */
public static com.rei.lolchat.service.aidl.IRoster asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.rei.lolchat.service.aidl.IRoster))) {
return ((com.rei.lolchat.service.aidl.IRoster)iin);
}
return new com.rei.lolchat.service.aidl.IRoster.Stub.Proxy(obj);
}
...
com.rei.lolchat.service.Contact _result = this.addContact(_arg0, _arg1, _arg2);
...
java.lang.String _arg0;
_arg0 = data.readString();
com.rei.lolchat.service.Contact _result = this.getContact(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<com.rei.lolchat.service.Contact> _result = this.getContactList();
reply.writeNoException();
...
java.lang.String _arg0;
_arg0 = data.readString();
com.rei.lolchat.service.PresenceAdapter _result = this.getPresence(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
com.rei.lolchat.service.aidl.IBeemRosterListener _arg0;
_arg0 = com.rei.lolchat.service.aidl.IBeemRosterListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.rei.lolchat.service.aidl.IRoster
{
...
public com.rei.lolchat.service.Contact addContact(java.lang.String user, java.lang.String name, java.lang.String[] groups) throws android.os.RemoteException
{
...
public void deleteContact(com.rei.lolchat.service.Contact contact) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public com.rei.lolchat.service.Contact getContact(java.lang.String jid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.rei.lolchat.service.Contact _result;
...
public java.util.List<com.rei.lolchat.service.Contact> getContactList() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
public com.rei.lolchat.service.PresenceAdapter getPresence(java.lang.String jid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.rei.lolchat.service.PresenceAdapter _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(jid);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.rei.lolchat.service.PresenceAdapter.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public void addRosterListener(com.rei.lolchat.service.aidl.IBeemRosterListener listen) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void removeRosterListener(com.rei.lolchat.service.aidl.IBeemRosterListener listen) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
