...
import com.rei.lolchat.ui.dialogs.builders.Alias;
import com.rei.lolchat.ui.dialogs.builders.ChatList;
import com.rei.lolchat.ui.dialogs.builders.DeleteContact;
import com.rei.lolchat.ui.dialogs.builders.ResendSubscription;
import com.rei.lolchat.utils.BeemBroadcastReceiver;
import com.rei.lolchat.utils.SortedList;
...
public class ContactList extends Activity {
	...
	private void bindView(View view, Contact curContact) {
	    if (curContact != null) {
			...
			if(curContact.getMsg() != null){
				String gameStatus = "";
				if(curContact.getGameStatus() != null){
					gameStatus = "["+curContact.getGameStatus()+"] ";
				}
				v.setText(gameStatus+curContact.getMsg());
			}else{
				v.setText("");
			}
	...
	private Drawable getAvatarStatusDrawable(String avatarId) {
	    ...
	    int profileId = 0;
	    try {
	    	profileId = Integer.parseInt(avatarId);
	    	avatarDrawable = getResources().getDrawable(BeemApplication.PROFILEIDS[profileId]);
	...
	public void onServiceConnected(ComponentName name, IBinder service) {
		...
		if (mRoster != null) {
		    ...
		    if (mSettings.getBoolean(BeemApplication.DEFAULT_STATUS_KEY, false)){
		    	String msg = mSettings.getString(BeemApplication.MSG_KEY, "");
		    	...
		    	mXmppFacade.changeStatus(Status.CONTACT_STATUS_AVAILABLE_FOR_CHAT, lolXml);
		    	edit.putBoolean(BeemApplication.DEFAULT_STATUS_KEY, false);
		    	}
