...
*/
package com.rei.lolchat.providers;
...
public class AvatarProvider extends ContentProvider {
	...
	Uri.parse("content://com.rei.lolchat.providers.avatarprovider");

    private static final String TAG = AvatarProvider.class.getSimpleName();
    private static final String AUTHORITY = "com.rei.lolchat.providers.avatarprovider";
	...
	File dataPath = new File(cacheDir, "/Android/data/com.rei.lolchat/cache/avatar");
	dataPath.mkdirs();
