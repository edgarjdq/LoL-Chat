...
public class BeemApplication extends Application {
    ...
    public static final String LEVEL_KEY = "account_level";
    public static final String WINS_KEY = "account_wins";
    public static final String LEAVES_KEY = "account_leaves";
    public static final String MSG_KEY = "account_msg";
    public static final String DEFAULT_STATUS_KEY = "enable_default_status";
    public static final String PROFILE_KEY = "account_profile_icon";
    public static final String SERVER_TEMP_KEY = "server_temp";
    public static final Integer[] PROFILEIDS = {
        R.drawable.profile0,
        R.drawable.profile1,
        R.drawable.profile2,
        R.drawable.profile3,
