 ...
 * Original file: /home/robi/projects/android/beam/beam/src/com/rei/lolchat/service/aidl/IChat.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.rei.lolchat.service.aidl.IChat
{
private static final java.lang.String DESCRIPTOR = "com.rei.lolchat.service.aidl.IChat";
...
/**
 * Cast an IBinder object into an com.rei.lolchat.service.aidl.IChat interface,
 * generating a proxy if needed.
 */
public static com.rei.lolchat.service.aidl.IChat asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.rei.lolchat.service.aidl.IChat))) {
return ((com.rei.lolchat.service.aidl.IChat)iin);
}
return new com.rei.lolchat.service.aidl.IChat.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.rei.lolchat.service.Contact _result = this.getParticipant();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
private static class Proxy implements com.rei.lolchat.service.aidl.IChat
{
...
/**
	 ...
	 */
public com.rei.lolchat.service.Contact getParticipant() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
